  ...
  return data ? (
    <div className="relative">
      ...
      <div className="text-center mt-20 text-gray-600">
        {" "}
        {/*use the moment package */}
        <p className="text-primary font-medium py-4">
          Publised on {Moment(data.createdAt).format("MMMM Do YYYY")}
        </p>
        ...
        <div className="mt-14 mb-10 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col gap-4 ">
            {comment.map((item, index) => (
              <div
                key={index}
                className="relative bg-primary/2 border border-primary/5 max-w-x; p-4 rounded text-gray-600"
              >

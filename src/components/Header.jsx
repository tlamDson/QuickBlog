...
const Header = () => {
  ...
  //when click the submit button so having it serach not search on each letter
  ...
  return (
    <div className="mx-8 sm:mx-16 xl:mx-24 relative">
      ...
      <div className="text-center">
        {input && <button onClick={onClear} className="border font-light text-xs py-1 px-3 rounded-sm shadow-custom-sm cursor-pointer">Clear Search
        </button>}
        </div>
      <img
